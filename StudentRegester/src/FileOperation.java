        ...
        for (String row : levelsAndStudentsIDs) {
            ...
            if (subSubRowStudentID[1].equals(studentID)) {
                if (subSubRowLevelID[1].equals("1")) {
                    ...
                    levels.add("Level6");
                }else if (subSubRowLevelID[1].equals("7")) {
                    levels.add("Level7");
                }else if (subSubRowLevelID[1].equals("8")) {
                    levels.add("Level8");
                }else if (subSubRowLevelID[1].equals("9")) {
                    levels.add("Level9");
                }else if (subSubRowLevelID[1].equals("10")) {
                    levels.add("Level10");
                }else if (subSubRowLevelID[1].equals("11")) {
                    levels.add("Level11");
                }else if (subSubRowLevelID[1].equals("12")) {
                    levels.add("Level12");
                }
            }
        }
